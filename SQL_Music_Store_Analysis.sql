...
-- We determine the most popular genre as the genre with the highest amount purchases.
...
-- the music for each country.Write a query that returns the country along
